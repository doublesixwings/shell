...
yum -y install kernel-ml-4.12.10-1.el6.elrepo.x86_64.rpm kernel-ml-devel-4.12.10-1.el6.elrepo.x86_64.rpm kernel-ml-headers-4.12.10-1.el6.elrepo.x86_64.rpm
